...
NeuralNetwork* NeuralNetwork_CreateNeuralNetwork(int numberOfInputNeurons, int numberOfHiddenLayers, int numberOfHiddenNeurons, int numberOfOutputNeurons) {
	...
	numberOfInputNeurons = numberOfInputNeurons + bias;
	numberOfHiddenNeurons = numberOfHiddenNeurons + bias;
...
NeuralNetwork* NeuralNetwork_DestroyNeuralNetwork(NeuralNetwork* myNeuralNetwork) {

	for (int i = 0; i < myNeuralNetwork->inputLayer.numberOfNeurons; i++) {
		free(myNeuralNetwork->inputLayer.neurons[i].weight);
	}
